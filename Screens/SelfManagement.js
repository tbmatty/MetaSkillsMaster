...
export default function SelfManagement(props) {
    ...
    return (
        ...
        <View style={styles.container}>
            ...
            <TouchableOpacity style={styles.button} onPress={()=>props.navigation.navigate("specificSkill", {skill: "Focussing"})}>
                <Text style={styles.buttonText}>Focussing</Text>
            </TouchableOpacity>
            <TouchableOpacity style={styles.button} onPress={()=>props.navigation.navigate("specificSkill", {skill: "Integrity"})}>
                <Text style={styles.buttonText} >Integrity</Text>
            </TouchableOpacity>
            <TouchableOpacity style={styles.button} onPress={()=>props.navigation.navigate("specificSkill", {skill: "Adapting"})}>
                <Text style={styles.buttonText}>Adapting</Text>
            </TouchableOpacity>
            <TouchableOpacity style={styles.button} onPress={()=>props.navigation.navigate("specificSkill", {skill: "Initiative"})}>
                <Text style={styles.buttonText}>Initiative</Text>
            </TouchableOpacity>
        </View>
    );
};
